        ...
        columns: [
            { data: 'memberName',
              render: function(data, type, row, meta) {
                ...
                tmp.push('<div class="winner-inline"><img class="winner-crown" src="../assets/img/winner-trophy.svg" alt="winner trophy"/>'.repeat(fiveCount));
                ...
                tmp.push(data);
                tmp.push('<div class="yakuman-inline"><img class="yakuman-crown" src="../assets/img/yakuman-badge.svg" alt="yakuman badge"/>'.repeat(row.yakumanCnt));
                tmp = tmp.join();

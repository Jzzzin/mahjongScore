...
const browserSyncPath = upath.resolve(upath.dirname(__filename), './node-modules/.bin/browser-sync');
...
concurrently([
    ...
    {
        command: `browser-sync --port 8001 --reload-delay 2000 --reload-debounce 2000 dist -w --no-online`,
